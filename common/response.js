...
module.exports = {
    continue: function (res, success = false, message, data) {
    ...
    switchingProtocols: function (res, success = false, message, data) {
    ...
    processing: function (res, success = false, message, data) {
    ...
    ok: function (res, success = false, message, data) {
    ...
    created: function (res, success = false, message, data) {
    ...
    accepted: function (res, success = false, message, data) {
    ...
    nonAuthoritativeInformation: function (res, success = false, message, data) {
    ...
    noContent: function (res, success = false, message, data) {
    ...
    resetContent: function (res, success = false, message, data) {
    ...
    partialContent: function (res, success = false, message, data) {
    ...
    multiStatus: function (res, success = false, message, data) {
    ...
    multipleChoices: function (res, success = false, message, data) {
    ...
    movedPermanently: function (res, success = false, message, data) {
    ...
    found: function (res, success = false, message, data) {
    ...
    seeOther: function (res, success = false, message, data) {
    ...
    notModified: function (res, success = false, message, data) {
    ...
    useProxy: function (res, success = false, message, data) {
    ...
    switchProxy: function (res, success = false, message, data) {
    ...
    temporaryRedirect: function (res, success = false, message, data) {
    ...
    badRequest: function (res, success = false, message, data) {
    ...
    unauthorized: function (res, success = false, message, data) {
    ...
    paymentRequired: function (res, success = false, message, data) {
    ...
    forbidden: function (res, success = false, message, data) {
    ...
    notFound: function (res, success = false, message, data) {
    ...
    methodNotAllowed: function (res, success = false, message, data) {
    ...
    notAcceptable: function (res, success = false, message, data) {
    ...
    proxyAuthenticationRequired: function (res, success = false, message, data) {
    ...
    requestTimeout: function (res, success = false, message, data) {
    ...
    conflict: function (res, success = false, message, data) {
    ...
    gone: function (res, success = false, message, data) {
    ...
    lengthRequired: function (res, success = false, message, data) {
    ...
    preconditionFailed: function (res, success = false, message, data) {
    ...
    requestEntityTooLarge: function (res, success = false, message, data) {
    ...
    requestURITooLong: function (res, success = false, message, data) {
    ...
    unsupportedMediaType: function (res, success = false, message, data) {
    ...
    requestedRangeNotSatisfiable: function (res, success = false, message, data) {
    ...
    expectationFailed: function (res, success = false, message, data) {
    ...
    imATeapot: function (res, success = false, message, data) {
    ...
    unprocessableEntity: function (res, success = false, message, data) {
    ...
    locked: function (res, success = false, message, data) {
    ...
    failedDependency: function (res, success = false, message, data) {
    ...
    unorderedCollection: function (res, success = false, message, data) {
    ...
    upgradeRequired: function (res, success = false, message, data) {
    ...
    retryWith: function (res, success = false, message, data) {
    ...
    internalServerError: function (res, success = false, message, data) {
    ...
    notImplemented: function (res, success = false, message, data) {
    ...
    badGateway: function (res, success = false, message, data) {
    ...
    serviceUnavailable: function (res, success = false, message, data) {
    ...
    gatewayTimeout: function (res, success = false, message, data) {
    ...
    HTTPVersionNotSupported: function (res, success = false, message, data) {
    ...
    variantAlsoNegotiates: function (res, success = false, message, data) {
    ...
    insufficientStorage: function (res, success = false, message, data) {
    ...
    bandwidthLimitExceeded: function (res, success = false, message, data) {
    ...
    notExtended: function (res, success = false, message, data) {
